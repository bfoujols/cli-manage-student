...
final class CommandStudentDirEcoleDirecteTest extends TestCase
{
    private $commandeTester;
    private $fileExport = ['export-etudiant-ecole-directe.xlsx'];

    protected function setUp(): void
    {
        $application = new Application("Manage Student CLI", "0.4.0@alpha");
